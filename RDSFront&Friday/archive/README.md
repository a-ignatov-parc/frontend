...
- [Why I think Elm is the Future of Front End Development](https://medium.com/@rgoomar/why-i-think-elm-is-the-future-of-front-end-development-21e9b091fa05) — преоткрывает занавесу над тем почему Elm классный.
...
##### Обзор редактора VIM - [Артем Даньшин](https://github.com/ArtDanshin)
Ссылки по теме:
